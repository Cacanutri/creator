...
export default async function VitrinePage({
  ...
  if (radiusKm !== null && lat !== null && lng !== null) {
    ...
    if (error) {
      rpcError = "Filtro por raio indisponível no momento.";
    } else {
    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-300">
              Descubra creators disponíveis e solicite propostas.
            </p>
          </div>
        </div>
        ...
        {(!offers || offers.length === 0) && (
          <div className="mt-8 text-sm text-zinc-300">Nenhuma oferta encontrada com esses filtros.</div>
        )}
      </div>
    </main>
  );
