...
export default async function BrandRatings() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-zinc-300">Avaliacoes recebidas dos creators.</p>
      ...
      <div className="mt-4 grid gap-2">
        {(ratings ?? []).map((r) => (
          <div key={r.id} className="rounded-lg border border-zinc-800 bg-zinc-900/30 p-3">
            ...
            <div className="mt-1 text-xs text-zinc-400">Creator: {r.from_user_id}</div>
